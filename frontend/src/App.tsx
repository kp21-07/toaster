...
function App() {
  ...
  const dummyNetlist = `* SPICE Netlist Generated by Toaster
V1 N0001 0 5V
R1 N0001 N0002 10k
LED1 N0002 0 Red
.backanno
.end`;
  ...
  const dummyComponents: CircuitComponent[] = [
      ...
      <div className="main-layout">
        ...
        <div className="column">
          ...
          <div>
            ...
            <ComponentList components={dummyComponents} />
          </div>

          <div>
            <h2 className="section-title">SPICE Output</h2>
            <NetlistViewer netlist={dummyNetlist} />
          </div>
